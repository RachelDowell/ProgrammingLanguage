        ...
        return Stream.of(
                Arguments.of("Hello, World!",
                        ...
                        Arguments.of("Multiple Fields and Methods",
                                ...
                                // END
                                new Ast.Source(
                                        Arrays.asList(init(new Ast.Stmt.Field("x", "Integer", Optional.empty()), ast -> ast.setVariable(new Environment.Variable("x", "x", Environment.Type.INTEGER, Environment.NIL))),
                                                init(new Ast.Stmt.Field("y", "Decimal", Optional.empty()), ast -> ast.setVariable(new Environment.Variable("y", "y", Environment.Type.DECIMAL, Environment.NIL))),
                                                init(new Ast.Stmt.Field("z", "String", Optional.empty()), ast -> ast.setVariable(new Environment.Variable("z", "z", Environment.Type.STRING, Environment.NIL)))),
                                        Arrays.asList(
                                                ...
                                                init(new Ast.Method("h", Arrays.asList(), Arrays.asList(), Optional.of("String"), Arrays.asList(
                                                        new Ast.Stmt.Return(init(new Ast.Expr.Literal("z"), ast -> ast.setType(Environment.Type.STRING)))
